...
writematrix(M, 'Y_orient_X_band_large_ZFS.txt');

save('Y_orient_X_band_large_ZFS.mat','spin_system','parameters','D','E','simulation_time','phi','r') 
