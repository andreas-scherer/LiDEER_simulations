...
parameters.carrier_frq=-8.709e9; 
...
writematrix(M, 'non_can_orient_X_band_TPP.txt');

save('non_can_orient_X_band_TPP.mat','spin_system','parameters','D','E','simulation_time','phi','r')
