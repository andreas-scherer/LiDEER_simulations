...
parameters.tau_start=0.15e-6+8e-9;  %a bit before 2*p1_p2_gap
...
writematrix(M, 'non_can_orient_X_band_large_ZFS.txt');

save('non_can_orient_X_band_large_ZFS.mat','spin_system','parameters','D','E','simulation_time','phi','r') 
